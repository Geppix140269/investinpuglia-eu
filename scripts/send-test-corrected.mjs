...
// Corrected professional email template
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; background-color: #f5f5f5;">
  <div style="max-width: 600px; margin: 0 auto; background: #ffffff;">
    ...
    <div style="padding: 30px;">
      ...
      <!-- PROMINENT Trullo AI Assistant Section -->
      <div style="background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%); color: white; padding: 20px; border-radius: 8px; text-align: center; margin: 25px 0;">
        <h3 style="margin: 0 0 10px 0; font-size: 20px;">🤖 Meet Trullo - Your 24/7 AI Investment Assistant</h3>
        <p style="margin: 0 0 15px 0; font-size: 15px;">Get instant answers about grants, properties, and investment opportunities in Puglia</p>
        <a href="https://investinpuglia.eu" 
           style="display: inline-block; background: white; color: #0891b2; padding: 10px 25px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 14px;">
      ...
      <div style="margin: 25px 0;">
        <h3 style="color: #1e293b; font-size: 18px; margin: 0 0 15px 0;">Our Team Combined Experience at Your Service:</h3>
      ...
      <!-- Free Tools with PROMINENT InvestiScope -->
      <div style="background: #f0f9ff; border-radius: 8px; padding: 20px; margin: 25px 0;">
        ...
        <div style="font-size: 15px; line-height: 1.8;">
          ...
          🤖 <a href="https://investinpuglia.eu" style="color: #0369a1; font-weight: 600;">Meet Trullo</a> - Our AI assistant for immediate answers<br>
          📊 <a href="https://investinpuglia.eu/portfolio" style="color: #0369a1;">View Our Portfolio</a> - €50M+ in successful projects
        </div>
      </div>
      
      <!-- CTA Section - EMPHASIZING FREE -->
...
async function sendTestEmail() {
  console.log('Sending CORRECTED Mini PIA campaign test to info@1402celsius.com...\n');
  console.log('Changes made:');
  console.log('✓ Portfolio link text fixed');
  console.log('✓ FREE consultation emphasized for first 50');
  console.log('✓ Mini PIA range corrected to €30K - €5M');
  console.log('✓ Changed to "project investments" (property + restructuring)');
  console.log('✓ Removed restaurants/hospitality from list');
  console.log('✓ Changed to "Our Team Combined Experience"');
  console.log('✓ Calculator link fixed to /tools');
  console.log('✓ Trullo AI made prominent at top\n');
  ...
  try {
    const { data, error } = await resend.emails.send({
      ...
      html: emailTemplate,
      tags: [
        { name: 'campaign', value: 'minipia-corrected-test' }
      ]
    });
    ...
    if (error) {
      ...
      console.log('✅ Corrected template test email sent successfully!');
