...
export default function AboutGiuseppe() {
  return (
    <section className="py-20 bg-gradient-to-br from-emerald-50 via-white to-amber-50/20 relative overflow-hidden" id="advisor">
      ...
      <div className="max-w-6xl mx-auto px-5 relative z-10">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-amber-500 text-white px-5 py-2 rounded-full text-sm font-semibold mb-6 shadow-lg">
            <Icon name="User" size={20} />
            YOUR ADVISOR
          </div>
          <h2 className="text-3xl md:text-5xl font-light text-gray-900 mb-4">
            Meet <strong className="font-bold bg-gradient-to-r from-emerald-600 to-amber-500 bg-clip-text text-transparent">Giuseppe Funaro</strong>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-600 to-amber-500 rounded-3xl transform rotate-3"></div>
            <CloudinaryImage 
            ...
            <div className="text-center mt-6">
              <a 
                ...
                className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm text-gray-700 hover:text-emerald-700 px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-all border border-white/50"
              >
