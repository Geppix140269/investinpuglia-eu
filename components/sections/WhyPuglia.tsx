    ...
    <section className="relative py-24 bg-gradient-to-br from-gray-50 via-white to-amber-50/20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-amber-500 text-white px-4 py-2 rounded-full text-sm font-semibold mb-6">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Why Work With Us
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-amber-500 mt-2">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl p-8 mb-16 border border-gray-100">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gradient-to-br from-emerald-50 to-emerald-100/50 rounded-2xl p-6">
              <div className="text-4xl font-bold text-emerald-700 mb-2">€150M+</div>
              <div className="text-sm font-semibold text-emerald-600 mb-1">Projects Managed</div>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-emerald-100/50 rounded-2xl p-6">
              ...
              <div className="text-sm font-semibold text-emerald-600 mb-1">Years Combined Expertise</div>
            ...
            <div className="space-y-4 mb-8">
              <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-gray-100">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-sm font-bold text-emerald-600">Expert Due Diligence</span>
                </div>
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-gray-100">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-sm font-bold text-emerald-600">Beyond Mini PIA</span>
                </div>
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-gray-100">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-sm font-bold text-emerald-600">End-to-End</span>
                </div>
                <p className="text-sm text-gray-600">From concept through completion with local contractors</p>
              </div>
            </div>

            <div className="bg-gradient-to-r from-emerald-100 to-amber-100/50 rounded-xl p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white border-2 border-emerald-200 rounded-xl p-5">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="bg-purple-100 text-emerald-700 px-3 py-1 rounded-full text-sm font-semibold">Established</span>
                </div>
              ...
              <div className="bg-white border-2 border-emerald-200 rounded-xl p-5">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="bg-purple-100 text-emerald-700 px-3 py-1 rounded-full text-sm font-semibold">Expert</span>
                </div>
        ...
        {/* Bottom CTA */}
        <div className="mt-16 text-center bg-gradient-to-r from-emerald-50 to-amber-50 rounded-3xl p-12">
          ...
          <Link
            href="/consultation"
            className="group px-10 py-5 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-bold text-lg rounded-full hover:from-emerald-700 hover:to-emerald-800 transition-all transform hover:scale-105 shadow-2xl inline-flex items-center gap-3"
          >
