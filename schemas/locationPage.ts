...
export default {
  ...
  fields: [
    ...
    },
    {
      name: 'seo',
      title: 'SEO Settings',
      type: 'seo', // Using your existing seo.ts schema
    },
    {
      name: 'heroTitle',
      title: 'Hero Title',
      ...
      of: [
        {
          type: 'object',
          fields: [
            { name: 'title', type: 'string', title: 'Incentive Title' },
            { name: 'description', type: 'text', title: 'Description', rows: 2 },
            { name: 'percentage', type: 'number', title: 'Percentage/Amount' },
          ],
        },
      ],
    },
    {
      ...
      fields: [
        ...
        { name: 'skillsAvailability', type: 'string', title: 'Skills Availability', options: {
          list: [
