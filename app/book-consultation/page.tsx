...
import { Clock, Euro, Calendar, CheckCircle, ArrowRight, Shield, Star, Users } from 'lucide-react';
  ...
  const consultationOptions = [
    {
      ...
      stripeUrl: process.env.NEXT_PUBLIC_STRIPE_CONSULTATION_30_URL || 'https://buy.stripe.com/your-30min-link',
    ...
    },
    {
      ...
      stripeUrl: process.env.NEXT_PUBLIC_STRIPE_CONSULTATION_60_URL || 'https://buy.stripe.com/your-60min-link',
