...
import { MapPin, Euro, Maximize, Home, Calendar, Shield, TrendingUp, Plane, Waves, Check, ArrowLeft } from 'lucide-react'
            ...
            <div className="grid grid-cols-2 gap-4">
              {property.images.slice(0, 4).map((image, index) => (
                <div
                  ...
                  className={`relative h-40 lg:h-60 rounded-lg overflow-hidden cursor-pointer ${
