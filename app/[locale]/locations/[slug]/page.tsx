...
export async function generateMetadata({ params }: { params: { slug: string, locale: string } }): Promise<Metadata> {
  ...
  return {
    title: location.seo?.metaTitle || `Invest in ${location.city} - Investment Opportunities in Puglia`,
    description: location.seo?.metaDescription || `Discover investment opportunities in ${location.city}, ${location.province}. Strategic location, incentives, and thriving industries.`,
    openGraph: {
      title: location.seo?.metaTitle || `Invest in ${location.city}`,
